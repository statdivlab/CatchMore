#' Three-component geometric mixture model for estimating species richness
#'
#' This function implements the species richness estimation with a three-component mixture
...
three_geometric_model <- function(input_data, cutoff = 10, ...) {
  ...
  alpha_estimate(estimate = C_hat,
                 ...
                 interval = C_confint,
                 interval_type = "Approximate: log-normal",
                 GOF0 = signif(pchisq(GOF0_threemixedexp$GOF, GOF0_threemixedexp$df, lower.tail = F), 4),
                 GOF5 = signif(pchisq(GOF5_threemixedexp$GOF, GOF5_threemixedexp$df, lower.tail = F), 4),
                 AICc = AICc,
                 other = list(t1 = t1,
                              t2 = t2,
                              t3 = t3,
...
#' Internal functions for estimating species richness with a three-component geomic mixture model
#'
#' @export
